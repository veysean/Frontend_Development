...
console.log(calculateTotalPrice(newShoppingCart));
console.log(calculateTotalPrice([{ name: "Peaches", price: 3, quantity: 2 }]));
console.log(calculateTotalPrice([{ name: "Peaches", price: 3, quantity: 2 }, { name: "Apples", price: 2.5, quantity: 3 }]));